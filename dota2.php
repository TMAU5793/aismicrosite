   ...
   <div class="container">
      ...
      <div class="desc-section pb-5 mt-5">
         ...
         <div class="gradient-gray mt-3">
            <div class="text-center">
               <img src="<?php echo 'assets/images/dota.png'; ?>" alt="" style="max-width:250px;">
            </div>
            <div class="list-item-ais mt-5">
               <span>ระยะเวลา</span>
               <ul>
                  <li>เปิดรับสมัคร 31 มกราคม – 31 มีนาคม 63</li>
                  <li>จำกัดจำนวนทีม 256 ทีม</li>
               ...
               <div class="award-list mt-3">
                  <ul class="list-unstyled">
                     <li class="color-green">
                        <h5>รางวัลที่ 1 : เงินสด 50,000 บาท + ตั๋วเครื่องบินพร้อมที่พัก มูลค่า 100,000 บาท</h5>
                     </li>
                     <li>
                        <h5>รางวัลที่ 2 : เงินสด 30,000 บาท</h5>
                     </li>
                     <li>
                        <h5>รางวัลที่ 3 : เงินสด 20,000 บาท</h5>
                     </li>
                     <li>
                        <h5>รางวัลที่ 4 : เงินสด 10,000 บาท</h5>
                     </li>
                     <li class="color-green">
                        <h5>รวมรางวัลเงินสด DOTA2 : 210,000 บาท</h5>
                     </li>
                  </ul>
               </div>
            </div>
            <div class="condition-method">
               ...
               <ul class="list-style-ais">
                  ...
                  <li>จำนวนผู้แข่งขันหลักทีมละ 5 คน สามารถมีตัวสำรองได้ 2 คน</li>
                  <li>ทีมที่สมัครเข้าแข่งขันจะถูกคัดเลือกให้เหลือ 4 ทีมเพื่อเข้าไปแข่งขันในรอบ Final ออฟไลน์ที่ AIS eSports Studio</li>
                  <li>ผู้ชนะเลิศของการแข่งขัน AIS eSports Thailand Corporate League เกมส์ Dota2 จะเป็นตัวแทนจากประเทศไทย ไปแข่งขัน PVP Esports Corporate Championship</li>
                  <li>เมื่อสิ้นสุดระยะเวลาในการเปิดรับสมัคร ทางทีมงานขอสงวนสิทธิ์ไม่ให้แก้ไข เปลี่ยนแปลงจำนวน และ รายชื่อสมาชิกในทีม ไม่ว่ากรณีใดทั้งสิ้น</li>
            ...
            <div class="property-list mt-5">
               ...
               <ul class="list-style-ais">
                  <li>ทีมผู้สมัครที่เข้าร่วมแข่งขันหลัก 5 คน สำรอง 2 คน จะต้องเป็นพนักงานบริษัทเดียวกัน</li>
                  <li>เกม DOTA 2 สมัครแบบทีม 5 คน สามารถมีผู้เล่นสํารองได้ 2 คน (ผู้เล่น 1 คน ลงสมัครแข่งขันได้ 1 ทีมเท่านั้น)</li>
                  <li>ผู้เข้าแข่งขันต้องแนบบัตรพนักงานเพื่อยืนยันตัวตนการสมัคร AIS eSports Thailand Corporate League ในกรณีผู้เข้าแข่งขันไม่มีบัตรพนักงาน จำเป็นต้องใช้เอกสารยืนยันจากทางบริษัทเพื่อรับรองการเป็นพนักงาน</li>
                  <li>ผู้สมัครเข้าร่วมแข่งขันจะต้องไม่เคยเข้ารอบสุดท้ายในการแข่งกีฬา eSports ระดับประเทศ (Non Professional Player) และไม่เคย ได้รับรางวัลในรายการ PVP Esports</li>
                  ...
                  <li>การแข่งขันรายการ AIS eSports Thailand Corporate League 2020 เปิดรับสมัครให้กับผู้เล่นทุกคน ทุกทีม และ ทุกระดับอย่างเท่าเทียม โดยไม่เสียค่าใช้จ่ายในการสมัครใดๆทั้งสิ้น หากพบเห็นผู้แอบอ้างเรียกค่าใช้จ่ายในการรับสมัคร สามารถแจ้งตรงกับทีมผู้ดูแลการจัดการแข่งขันในแท็บ ถาม-ตอบตรง</li>
               </ul>
            </div>
